...
class TestDataset(Dataset):
    def __init__(self, test_dir, id2label, transform=None):
        ...
        self.raw_samples = []  # simpan path + label untuk visualisasi
...
# Kumpulkan path gambar per kelas
...
# Buat figure grid: baris = kelas, kolom = sampel
...
# Kumpulkan hasil prediksi per kelas
