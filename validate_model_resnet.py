...
plt.title("Akurasi Per Kelas - ResNet50", fontsize=14, fontweight="bold")
...
history_path = "history_resnet.json"
if os.path.exists(history_path):
    ...
    fig.suptitle("Training History - ResNet50", fontsize=16, fontweight="bold")
    ...
    plt.close()
    print("Training history chart saved to training_history_resnet.png")
else:
...
print("  - training_history_resnet.png")
